        ...
        <>
            ...
            >
                <div className="grid grid-cols-[2fr_1fr]">
                    <div className="">
                        <h6 className="mb-2 pl-[15px] pt-[2px] xl:pl-[10px] xl:pt-[2px] text-[26px] md:text-[20px] xl:text-[23px] font-bold tracking-tight text-gray-100 dark:text-white">
                            {title}
                        </h6>
                        <p className="text-gray-200  font-sans text-[15px] md:text-[10px] ml-[17px] -mt-[10px] xl:ml-[10px] xl:-mt-[10px]">
                            <i>{subTitle}</i>
                        </p>
                    </div>
                    <div className="">
