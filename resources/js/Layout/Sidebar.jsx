...
const Sidebar = ({ flash, status, children }) => {
    ...
    return (
        <>
            <nav className="fixed top-0 z-50 w-full sidebar border-b border-green-900 dark:bg-gray-800 dark:border-gray-700">
